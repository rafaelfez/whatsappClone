        ...
        <Image style={{ flex: 1, width: null }} source={require('../imgs/bg.png')} >
            <View style={{ flex:1, padding: 10 }}>
                <View style={{ flex: 4, justifyContent: 'center' }}>
                    ...
                    <TextInput value={props.senha} placeholder="Senha" placeholderTextColor='#fff' style={{ fontSize: 20, height: 45 }} secureTextEntry onChangeText={texto => props.modificaSenha(texto)} />
                </View>
                <View style={{ flex:1 }}>
