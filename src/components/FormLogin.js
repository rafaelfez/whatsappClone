		...
		<Image style={{ flex: 1, width: null }} source={require('../imgs/bg.png')} > 
			<View style={{ flex: 1, padding: 10 }}>
				...
				<View  style={{ flex: 2}}>
					...
					<TextInput value={props.senha} style={{ fontSize: 20, height: 45 }} placeholder='Senha' placeholderTextColor='#fff' secureTextEntry onChangeText={texto => props.modificaSenha(texto)} />
